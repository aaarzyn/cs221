...
grader.add_basic_part('3g-1-hidden', test3g1, max_seconds=2, description="train_linear_classifier gradient test")
...
grader.add_basic_part('4f-1-hidden', test4f1, max_seconds=2, description="train_mlp_classifier shape test")
